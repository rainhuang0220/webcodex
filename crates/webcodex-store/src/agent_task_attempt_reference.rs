            ...
            .query_row(
                "SELECT ref_index, task_id, attempt_id, assignee_agent_id, attempt_fence,
                 ...
                 WHERE principal_digest = ?1
                   ...
                   AND attempt_fence = ?5
                   AND attempt_controller_generation = ?6",
                params![
                    principal.digest,
                    task_id,
                    attempt_id,
        ...
        transaction
            .execute(
                "INSERT INTO wc_agent_task_attempt_references (
                    principal_digest, ref_index, task_id, attempt_id, assignee_agent_id,
                    attempt_fence, attempt_controller_generation, created_at_unix_ms
